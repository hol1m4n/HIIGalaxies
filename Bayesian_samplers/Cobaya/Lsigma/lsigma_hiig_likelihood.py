...
class LSigmaHIIG(Likelihood):
    ...
    def get_requirements(self):
        ...
        return {
            ...
            "Hubble": {"z": self.z_hiig, "units": "km/s/Mpc"},
    ...
    # IMPORTANTE: los parámetros deben nombrarse explícitamente aquí (no
    # **kwargs). Cobaya inspecciona esta firma para saber qué parámetros
    # muestreados pertenecen a ESTA likelihood; con **kwargs, Cobaya no
    # puede distinguirlos y termina también ofreciéndoselos a `classy`,
    # que los rechaza porque no son parámetros cosmológicos reconocidos.
