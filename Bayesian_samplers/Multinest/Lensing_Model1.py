...
Lsig_Ho_sampler(
    ...
    folder_name="Lens_FlatLCDM",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM_CepnZeR",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM_CepnZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM_CepnZeT",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM_CepnZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM_CepcZeR",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM_CepcZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM_CepcZeT",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM_CepcZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM_TRGB",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM_TRGB',
)
