...
class Lsig_Ho_sampler:
    ...
    def main_sampler(self):
        ...
        def prior_transform(u):
            ...
            wDE    =  -2.0 +  2.0 * u[5]  # -2.0 -> 0.0
            return np.array([alpha, beta, h, Om, Ode, wDE])
        ...
        parameters = [r"\alpha", r"\beta", r"h",r"\Omega_m",r"\Omega_{\Lambda}",r"{\omega}_{DE}"]
        ...
        gds = MCSamples(
            samples=samples,
            names=["alpha", "beta", "h","Om","Ode","wDE"],
            labels=[r"\alpha", r"\beta", r"h",r"\Omega_m",r"\Omega_{\Lambda}",r"{\omega}_{DE}"] 
        )
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_wCDM_CepnZeR",
    analysis_mode='High',
    id_prefix='Lens_wCDM_CepnZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_wCDM_CepnZeT",
    analysis_mode='High',
    id_prefix='Lens_wCDM_CepnZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_wCDM_CepcZeR",
    analysis_mode='High',
    id_prefix='Lens_wCDM_CepcZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_wCDM_CepcZeT",
    analysis_mode='High',
    id_prefix='Lens_wCDM_CepcZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_wCDM_TRGB",
    analysis_mode='High',
    id_prefix='Lens_wCDM_TRGB',
)
