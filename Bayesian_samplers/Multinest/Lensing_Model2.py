...
class Lsig_Ho_sampler:
    ...
    def main_sampler(self):
        ...
        def prior_transform(u):
            ...
            return np.array([alpha, beta, h, Om])
        ...
        gds = MCSamples(
            samples=samples,
            names=["alpha", "beta", "h","Om"],
            labels=[r"\alpha", r"\beta", r"h",r"\Omega_m"] 
        )
...
Lsig_Ho_sampler(
    ...
    folder_name="Lens_FlatLCDM2",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM2',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM2_CepnZeR",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM2_CepnZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM2_CepnZeT",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM2_CepnZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM2_CepcZeR",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM2_CepcZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM2_CepcZeT",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM2_CepcZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatLCDM2_TRGB",
    analysis_mode='High',
    id_prefix='Lens_FlatLCDM2_TRGB',
)
