...
class Lsig_Ho_sampler:
    ...
    def main_sampler(self):
        ...
        def prior_transform(u):
            ...
            w0    =  -2.0 +  2.0 * u[4]   # -2.0 -> 0.0
            wa    =  -2.0 +  4.0 * u[5]  # -2.0 -> 2.0
            return np.array([alpha, beta, h, Om, w0, wa])
        ...
        parameters = [r"\alpha", r"\beta", r"h",r"\Omega_m",r"\omega_{0}",r"{\omega}_{a}"]
        ...
        gds = MCSamples(
            samples=samples,
            names=["alpha", "beta", "h","Om","w0","wa"],
            labels=[r"\alpha", r"\beta", r"h",r"\Omega_m",r"\omega_{0}",r"{\omega}_{a}"] 
        )
...
Lsig_Ho_sampler(
    ...
    folder_name="Lens_FlatCPL",
    analysis_mode='High',
    id_prefix='Lens_FlatCPL',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatCPL_CepnZeR",
    analysis_mode='High',
    id_prefix='Lens_FlatCPL_CepnZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatCPL_CepnZeT",
    analysis_mode='High',
    id_prefix='Lens_FlatCPL_CepnZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatCPL_CepcZeR",
    analysis_mode='High',
    id_prefix='Lens_FlatCPL_CepcZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatCPL_CepcZeT",
    analysis_mode='High',
    id_prefix='Lens_FlatCPL_CepcZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_FlatCPL_TRGB",
    analysis_mode='High',
    id_prefix='Lens_FlatCPL_TRGB',
)
