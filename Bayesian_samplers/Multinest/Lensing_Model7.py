...
class Lsig_Ho_sampler:
    ...
    def lnlike(
        ...
        alpha, beta, h, Om, Ode, w0, wa = theta
    ...
    def main_sampler(self):
        ...
        def prior_transform(u):
            ...
            Ode    =  0.0 +  1.0 * u[4]   # 0.0 -> 0.1
            w0    =  -2.0 +  2.0 * u[5]   # -2.0 -> 0.0
            wa    =  -2.0 +  4.0 * u[6]   # -2.0 -> 2.0
            return np.array([alpha, beta, h, Om, Ode, w0, wa])
        ...
        parameters = [r"\alpha", r"\beta", r"h",r"\Omega_m",r"\Omega_{\Lambda}",r"\omega_{0}",r"{\omega}_{a}"]
        ...
        gds = MCSamples(
            samples=samples,
            names=["alpha", "beta", "h","Om","Ode","w0","wa"],
            labels=[r"\alpha", r"\beta", r"h",r"\Omega_m",r"\Omega_{\Lambda}",r"\omega_{0}",r"{\omega}_{a}"] 
        )
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_CPL_CepnZeR",
    analysis_mode='High',
    id_prefix='Lens_CPL_CepnZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_CPL_CepnZeT",
    analysis_mode='High',
    id_prefix='Lens_CPL_CepnZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_CPL_CepcZeR",
    analysis_mode='High',
    id_prefix='Lens_CPL_CepcZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_CPL_CepcZeT",
    analysis_mode='High',
    id_prefix='Lens_CPL_CepcZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_CPL_TRGB",
    analysis_mode='High',
    id_prefix='Lens_CPL_TRGB',
)
