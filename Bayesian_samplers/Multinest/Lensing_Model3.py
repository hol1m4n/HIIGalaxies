...
class Lsig_Ho_sampler:
    ...
    def main_sampler(self):
        ...
        def prior_transform(u):
            ...
            return np.array([alpha, beta, h, Om, Ode])
        ...
        gds = MCSamples(
            samples=samples,
            names=["alpha", "beta", "h","Om","Ode"],
            labels=[r"\alpha", r"\beta", r"h",r"\Omega_m",r"\Omega_{\Lambda}"] 
        )
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_LCDM_CepnZeR",
    analysis_mode='High',
    id_prefix='Lens_LCDM_CepnZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_LCDM_CepnZeT",
    analysis_mode='High',
    id_prefix='Lens_LCDM_CepnZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_LCDM_CepcZeR",
    analysis_mode='High',
    id_prefix='Lens_LCDM_CepcZeR',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_LCDM_CepcZeT",
    analysis_mode='High',
    id_prefix='Lens_LCDM_CepcZeT',
)
...
Lsig_Ho_sampler(
    ...
    estimator_error_kind='sigma_w',
    main_title="Lensing test",
    folder_name="Lens_LCDM_TRGB",
    analysis_mode='High',
    id_prefix='Lens_LCDM_TRGB',
)
