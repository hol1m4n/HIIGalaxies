...
if __name__ == "__main__":
    ...
    parser.add_argument("--Path",     type=str, help="Ruta donde se guardaran los archivos y la libreria extraida")
    parser.add_argument("--IMF",      type=str, help="IMF seleccionada: Chabrier, Kroupa o Salpeter")
    parser.add_argument("--Mup",      type=str, help="Mup seleccioada: 100, 300 o 600")
    parser.add_argument("--Z",        type=list, help="Lista de strings con las metalicidades seleccionadas: '0000','0001','0002','0005','001','002','004','006','008','010','014','017','020','030','040','060'")
    parser.add_argument("--Ages",     type=list, help=f"Lista de floats con las edades seleccionadas (1-221):{tabla_edades}")
