...
def SDSS_mask_builder(O_o):
#for O_o in range(10): #len(spec_list)):
    print(spec_list[O_o])
    ...
    print(f"Done for {ID}")
    return f"Done for {ID}"

tmp = Parallel(n_jobs=-1)(delayed(SDSS_mask_builder)(x) for x in range(len(spec_list)))
